...
For a real-world example, check out [[https://github.com/gicrisf/skills][gicrisf/skills]], a collection of AI agent skills exported from Org-mode with ox-skills. It demonstrates:
...
- A [[https://github.com/gicrisf/skills/tree/main/skills/meta/org-skill-maker][org-skill-maker]] meta-skill to bootstrap new skills interactively
